...
export function OrdersView() {
     ...
     const [pendingOrderIdForConfirmation, setPendingOrderIdForConfirmation] = useState<string | null | undefined>(
          undefined
     );
     ...
     const handleDiscardChanges = () => {
          ...
          if (pendingOrderIdForConfirmation === null) {
               ...
               setSelectedOrderId(pendingOrderIdForConfirmation!);
               navigate(`/orders/${pendingOrderIdForConfirmation!}`);
          }
     ...
     return (
          <>
               <SplitViewLayout
                    ...
                    drawerContent={<CreateOrderView width={1100} onClose={closeDrawer} onSave={handleOrderCreated} />}
