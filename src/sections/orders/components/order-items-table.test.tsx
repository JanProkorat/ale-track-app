...
describe('OrderItemsTable', () => {
     ...
     it('should not render rows for products not found in allProducts', () => {
          const unknownOrderProducts = [new CreateOrderItemDto({ productId: 'unknown-id', quantity: 3 })];
     ...
     it('should render products from brewery groups', () => {
          ...
          const orderProductsFromBrewery = [new CreateOrderItemDto({ productId: 'p1', quantity: 7 })];
