...
describe('DaysOfMonthPicker', () => {
     ...
     it('should render the legend label', () => {
          render(<DaysOfMonthPicker selectedDays={[]} onDaysOfMonthPicked={mockOnDaysOfMonthPicked} errors={{}} />);
     ...
     it('should render 31 checkboxes for each day of the month', () => {
          const { container } = render(
               <DaysOfMonthPicker selectedDays={[]} onDaysOfMonthPicked={mockOnDaysOfMonthPicked} errors={{}} />
          );
     ...
     it('should call onDaysOfMonthPicked with added day when checking a box', () => {
          const { container } = render(
               <DaysOfMonthPicker selectedDays={[1]} onDaysOfMonthPicked={mockOnDaysOfMonthPicked} errors={{}} />
          );
     ...
     it('should call onDaysOfMonthPicked with removed day when unchecking a box', () => {
          const { container } = render(
               <DaysOfMonthPicker selectedDays={[1, 5, 10]} onDaysOfMonthPicked={mockOnDaysOfMonthPicked} errors={{}} />
          );
