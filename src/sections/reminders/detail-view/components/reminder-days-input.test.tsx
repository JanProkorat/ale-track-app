...
describe('ReminderDaysInput', () => {
     ...
     it('should render the label', () => {
          render(<ReminderDaysInput selectedValue={5} onSelectedValueChange={mockOnSelectedValueChange} errors={{}} />);

          expect(screen.getAllByText('reminders.numberOfDaysToRemindBefore')[0]).toBeInTheDocument();
     });

     it('should display the current value', () => {
          render(<ReminderDaysInput selectedValue={7} onSelectedValueChange={mockOnSelectedValueChange} errors={{}} />);
