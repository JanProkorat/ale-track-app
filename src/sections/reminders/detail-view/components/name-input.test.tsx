...
describe('NameInput', () => {
     ...
     it('should render the label', () => {
          render(<NameInput name="" setName={mockSetName} errors={{}} />);

          expect(screen.getAllByText('reminders.name')[0]).toBeInTheDocument();
     });

     it('should display the current name value', () => {
          render(<NameInput name="My Reminder" setName={mockSetName} errors={{}} />);
     ...
     it('should show error state when errors.name is set', () => {
          render(<NameInput name="test" setName={mockSetName} errors={{ name: 'Required' }} />);
