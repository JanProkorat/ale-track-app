...
export function UpdateProductDeliveryView({
     ...
     useEffect(() => {
          ...
          if (numericState === ProductDeliveryState.Finished) setIsWarningVisible(true);
          else if (isWarningVisible) setIsWarningVisible(false);
                                   ...
                                   {delivery.stops!.map((stop, index) => (
                                        <SortableView id={stop.publicId!} key={stop.publicId!}>
                                             <UpdateProductDeliveryStopView
                                                  ...
                                                  onDeleteClicked={() => {
                                                       const updatedStops = delivery.stops!.filter(
                                                            (_, i) => i !== index
                                                       );
                                                       onChange(
                                                            new UpdateProductDeliveryDto({
