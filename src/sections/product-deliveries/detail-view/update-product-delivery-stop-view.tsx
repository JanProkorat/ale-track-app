...
import { UpdateProductDeliveryItemDto } from '../../../api/Client';
import { DeliveryItemsTable } from '../components/delivery-items-table';

import type { BreweryDto, BreweryProductListItemDto, UpdateProductDeliveryStopDto } from '../../../api/Client';
          ...
          <>
               ...
               >
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center' }}>
                         ...
                         <IconButton disabled={disabled} onClick={onDeleteClicked} color="error">
                         ...
                         <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                              ...
                              <ProductsSelect
                                   ...
                                   key={
                                        ...
                                        '-' +
                                        (productDeliveryStop.products?.length ?? 0)
                                   }
                                   products={products}
