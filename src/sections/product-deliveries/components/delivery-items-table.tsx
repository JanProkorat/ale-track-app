...
export function DeliveryItemsTable<T extends AllowedItem>({
     deliveryProducts,
     products,
     onProductsChanged,
     disabled,
}: Readonly<DeliveryItemsTableProps<T>>) {
     ...
     return (
          <TableContainer sx={{ mt: 2, maxWidth: '100%', overflowX: 'auto' }}>
               <Table sx={{ minWidth: 800 }}>
                    ...
                    />
                    <TableBody>
                         {getSortedProducts().map((row, index) => {
                              ...
                              return product === undefined ? null : (
                                   <ProductDeliveryStopProductRow
                                        ...
                                        onQuantityChange={(quantity) => {
                                             ...
                                             const ctor =
                                                  existing instanceof UpdateProductDeliveryItemDto
