...
export function ProductDeliverySelect({deliveries, selectedDeliveryId, onSelect}: Readonly<ProductDeliverySelectProps>) {
        ...
        <FormControl fullWidth sx={{ mt: 1 }}>
            ...
            >
                {deliveries.map((delivery) => (
                    <MenuItem key={delivery.id} value={delivery.id} onClick={() => onSelect(delivery.id!)} sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 1 }}>
