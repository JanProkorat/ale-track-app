...
import { BreweryProductListItemDto, UpdateProductDeliveryItemDto, CreateProductDeliveryItemDto } from 'src/api/Client';
...
describe('DeliveryItemsTable', () => {
     ...
     it('should render product rows with CreateProductDeliveryItemDto', () => {
          const deliveryProducts = [new CreateProductDeliveryItemDto({ productId: 'p1', quantity: 10 })];
     ...
     it('should call onProductsChanged when quantity changes', () => {
          const deliveryProducts = [new UpdateProductDeliveryItemDto({ productId: 'p1', quantity: 5 })];
     ...
     it('should preserve CreateProductDeliveryItemDto type when changing quantity', () => {
          const deliveryProducts = [new CreateProductDeliveryItemDto({ productId: 'p1', quantity: 5 })];
     ...
     it('should not render row for product not found in products list', () => {
          const deliveryProducts = [new UpdateProductDeliveryItemDto({ productId: 'unknown-id', quantity: 1 })];
