...
describe('DriversSelect', () => {
     ...
     it('should show error state when shouldValidate is true and no drivers selected', () => {
          render(<DriversSelect selectedDriverIds={[]} drivers={mockDrivers} shouldValidate onSelect={mockOnSelect} />);
     ...
     it('should not show error when drivers are selected and shouldValidate is true', () => {
          render(
               <DriversSelect selectedDriverIds={['d1']} drivers={mockDrivers} shouldValidate onSelect={mockOnSelect} />
          );
