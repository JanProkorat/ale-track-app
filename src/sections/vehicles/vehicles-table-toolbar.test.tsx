...
describe('VehiclesTableToolbar', () => {
     ...
     it('should render the search input with placeholder', () => {
          render(<VehiclesTableToolbar numSelected={0} filterName="" onFilterName={mockOnFilterName} />);

          expect(screen.getByPlaceholderText('vehicles.name...')).toBeInTheDocument();
     });

     it('should display the current filter value', () => {
          render(<VehiclesTableToolbar numSelected={0} filterName="truck" onFilterName={mockOnFilterName} />);
     ...
     it('should pass numSelected to TableToolbar', () => {
          render(<VehiclesTableToolbar numSelected={2} filterName="" onFilterName={mockOnFilterName} />);
