...
describe('ProductTypeSelect', () => {
     ...
     it('should render selected type as chip', () => {
          render(<ProductTypeSelect {...defaultProps} selectedType={ProductType.PaleDraftBeer} />);
     ...
     it('should not show error when shouldValidate is true and type is selected', () => {
          render(<ProductTypeSelect {...defaultProps} shouldValidate selectedType={ProductType.Radler} />);
