...
vi.mock('../components/orders-select', () => ({
    OrdersSelect: ({
        ...
        <div data-testid="orders-select">
            <button onClick={() => onSelect([['ord-1', 100], ['ord-2', 200]])}>set-orders</button>
        </div>
    ),
}));
...
describe('OutgoingShipmentDetailView', () => {
    ...
    it('displays the current shipment name', () => {
        ...
        expect(document.querySelector('[data-testid="shipment-name"]')).toHaveTextContent(
            'My Shipment'
        );
    });
    ...
    it('calls onChange with new state when state is changed', () => {
        ...
        fireEvent.click(
            document.querySelector('[data-testid="shipment-state-select"] button')!
        );
    ...
    it('calls onChange with new delivery date', () => {
        ...
        fireEvent.click(
            document.querySelector('[data-testid="shipment-date-picker"] button')!
        );
    ...
    it('calls onChange with new name when name is changed', () => {
        ...
        fireEvent.click(
            document.querySelector('[data-testid="shipment-name-input"] button')!
        );
    ...
    it('calls onChange with new vehicle when vehicle is selected', () => {
        ...
        fireEvent.click(
            document.querySelector('[data-testid="shipment-vehicle-select"] button')!
        );
    ...
    it('calls onChange with selected orders', () => {
        ...
        fireEvent.click(
            document.querySelector('[data-testid="orders-select"] button')!
        );
