...
describe('ShipmentNameInput', () => {
     ...
     it('should render the label', () => {
          render(<ShipmentNameInput shipmentName="" shouldValidate={false} onNameChange={mockOnNameChange} />);
     ...
     it('should display the current shipment name', () => {
          render(
               <ShipmentNameInput shipmentName="Test Shipment" shouldValidate={false} onNameChange={mockOnNameChange} />
          );
     ...
     it('should show error state when shouldValidate is true and name is empty', () => {
          render(<ShipmentNameInput shipmentName="" shouldValidate onNameChange={mockOnNameChange} />);
     ...
     it('should not show error state when shouldValidate is true and name is provided', () => {
          render(<ShipmentNameInput shipmentName="Valid Name" shouldValidate onNameChange={mockOnNameChange} />);
     ...
     it('should be disabled when disabled prop is true', () => {
          render(<ShipmentNameInput shipmentName="" shouldValidate={false} onNameChange={mockOnNameChange} disabled />);
