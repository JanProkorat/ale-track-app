...
describe('OutgoingShipmentSelect', () => {
     ...
     it('should render a chip with selected shipment name and date', () => {
          render(<OutgoingShipmentSelect shipments={mockShipments} selectedShipmentId="s1" onSelect={mockOnSelect} />);
     ...
     it('should show empty message when no shipments available', async () => {
          render(<OutgoingShipmentSelect shipments={[]} selectedShipmentId={undefined} onSelect={mockOnSelect} />);
