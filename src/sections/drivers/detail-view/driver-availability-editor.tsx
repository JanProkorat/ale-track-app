...
import { Box, List, Divider, ListItem, IconButton, Typography, ListItemText, FormHelperText } from '@mui/material';
...
export const DriverAvailabilityEditor: React.FC<DriverAvailabilityEditorProps> = ({ availableDates, onChange }) => {
