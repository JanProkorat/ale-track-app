...
describe('DriversAvailabilityCalendar', () => {
     ...
     it('should navigate to the previous month', async () => {
          ...
          expect(screen.getByText(`${prevMonthKey} ${prevMonth.format('YYYY')}`)).toBeInTheDocument();
     });
     ...
     it('should navigate to the next month', async () => {
          ...
          expect(screen.getByText(`${nextMonthKey} ${nextMonth.format('YYYY')}`)).toBeInTheDocument();
     });
     ...
     it('should display multiple drivers on the same date', () => {
          ...
          render(<DriversAvailabilityCalendar drivers={[driverWithAvailability, driver2SameDay]} />);
