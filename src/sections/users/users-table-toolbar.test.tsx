...
describe('UsersTableToolbar', () => {
     ...
     it('should render the search input with placeholder', () => {
          render(<UsersTableToolbar numSelected={0} filterUserName={null} onFilterUserName={mockOnFilterUserName} />);

          expect(screen.getByPlaceholderText('users.userName...')).toBeInTheDocument();
     });

     it('should display the current filter value', () => {
          render(<UsersTableToolbar numSelected={0} filterUserName="john" onFilterUserName={mockOnFilterUserName} />);

          expect(screen.getByDisplayValue('john')).toBeInTheDocument();
     });

     it('should call onFilterUserName when input changes', () => {
          render(<UsersTableToolbar numSelected={0} filterUserName="" onFilterUserName={mockOnFilterUserName} />);
     ...
     it('should pass numSelected to TableToolbar', () => {
          render(<UsersTableToolbar numSelected={3} filterUserName={null} onFilterUserName={mockOnFilterUserName} />);
