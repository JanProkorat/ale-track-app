...
export function UpdateClientView({
     ...
     const fetchClient = useCallback(async () => {
          ...
          const data = await executeApiCall(() => clientApi.getClientDetailEndpoint(id), t('clients.loadDetailError'));
     ...
     const saveClient = async (): Promise<boolean> => {
          ...
          let hasError = false;
          await executeApiCall(() => clientApi.updateClientEndpoint(id, updateDto.toJSON()), t('clients.saveError'), {
               onError: () => {
                    hasError = true;
               },
          });
     ...
     const deleteClient = useCallback(async () => {
          const result = await executeApiCall(() => clientApi.deleteClientEndpoint(id));
