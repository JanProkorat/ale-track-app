            ...
            >
                <Box sx={{ width: 700, p: 2 }}>
                    {selectedReminderId === null ?
                        <CreateReminderView parentId={clientId} parentType="client" onClose={closeDrawer} selectedType={selectedType} /> :
                        <UpdateReminderView reminderId={selectedReminderId!} parentType="client" onClose={closeDrawer} />
                    }
                </Box>
            </Drawer>
        </CollapsibleForm>
