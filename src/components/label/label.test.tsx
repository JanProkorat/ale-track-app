...
describe('Label', () => {
     ...
     it('renders start icon', () => {
          renderLabel(<Label startIcon={<span data-testid="start-icon">★</span>}>labeled</Label>);
          expect(screen.getByTestId('start-icon')).toBeInTheDocument();
     });

     it('renders end icon', () => {
          renderLabel(<Label endIcon={<span data-testid="end-icon">✓</span>}>labeled</Label>);
          expect(screen.getByTestId('end-icon')).toBeInTheDocument();
     });

     it('renders both start and end icons', () => {
          renderLabel(
               <Label startIcon={<span data-testid="s-icon">★</span>} endIcon={<span data-testid="e-icon">✓</span>}>
                    labeled
               </Label>
          );
     ...
     it.each<LabelVariant>(['filled', 'outlined', 'soft', 'inverted'])('renders with variant %s', (variant) => {
