...
import {
     useBreweryReminders,
     useCreateBreweryReminder,
     useUpdateBreweryReminder,
     useDeleteBreweryReminder,
     useSetBreweryReminderResolved,
} from 'src/hooks/useBreweries';
...
export interface BreweryRemindersTabHandle {
     openCreateDialog: () => void;
}

interface BreweryRemindersTabProps {
     breweryId: string;
}

const BreweryRemindersTab = forwardRef<BreweryRemindersTabHandle, BreweryRemindersTabProps>(
function BreweryRemindersTab({ breweryId }, ref) {
     const { t } = useTranslation();
     const enumLabel = useEnumLabel();

     const { data: reminders, isLoading } = useBreweryReminders(breweryId);
     const createMutation = useCreateBreweryReminder();
     const updateMutation = useUpdateBreweryReminder();
     const deleteMutation = useDeleteBreweryReminder();
     const resolveMutation = useSetBreweryReminderResolved();
     ...
     const handleSave = () => {
          if (editingId) {
               ...
               updateMutation.mutate(
                    { breweryId, reminderId: editingId, data: dto },
     ...
     const handleDelete = () => {
          ...
          deleteMutation.mutate(
               { breweryId, reminderId: deleteTarget },
...
export default BreweryRemindersTab;
