...
describe('AccountPopover', () => {
     ...
     it('opens popover when button is clicked', () => {
          const { getByRole, getByText } = renderWithProviders(<AccountPopover />, { theme: cssVarsTheme });
     ...
     it('shows language and currency popovers in the popover', () => {
          const { getByRole, getByTestId } = renderWithProviders(<AccountPopover />, { theme: cssVarsTheme });
