...
describe('LanguagePopover', () => {
     ...
     it('renders the Languages button', () => {
          const { getByLabelText } = renderWithProviders(<LanguagePopover data={languages} />, { theme: cssVarsTheme });

          expect(getByLabelText('Languages button')).toBeInTheDocument();
     });

     it('renders a flag image for the current language', () => {
          const { container } = renderWithProviders(<LanguagePopover data={languages} />, { theme: cssVarsTheme });
     ...
     it('renders with empty data array', () => {
          const { getByLabelText } = renderWithProviders(<LanguagePopover />, { theme: cssVarsTheme });
