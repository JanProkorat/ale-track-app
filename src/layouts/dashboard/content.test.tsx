...
describe('DashboardContent', () => {
     ...
     it('renders container with id', () => {
          const { container } = renderWithProviders(<DashboardContent>Content</DashboardContent>);
     ...
     it('renders with disablePadding', () => {
          renderWithProviders(<DashboardContent disablePadding>Content</DashboardContent>);
          expect(screen.getByText('Content')).toBeInTheDocument();
     });

     it('renders with custom maxWidth', () => {
          renderWithProviders(<DashboardContent maxWidth="sm">Content</DashboardContent>);
          expect(screen.getByText('Content')).toBeInTheDocument();
     });
});
