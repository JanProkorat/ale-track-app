...
describe('AuthContent', () => {
     it('renders children', () => {
          const { getByText } = renderWithProviders(<AuthContent>Login form here</AuthContent>, {
               theme: cssVarsTheme,
          });
     ...
     it('applies layout content class', () => {
          const { container } = renderWithProviders(<AuthContent>Content</AuthContent>, { theme: cssVarsTheme });
     ...
     it('merges custom className', () => {
          const { container } = renderWithProviders(<AuthContent className="custom-auth">Content</AuthContent>, {
               theme: cssVarsTheme,
          });
     ...
     it('passes additional props', () => {
          const { container } = renderWithProviders(<AuthContent data-testid="auth-content">Content</AuthContent>, {
               theme: cssVarsTheme,
          });
