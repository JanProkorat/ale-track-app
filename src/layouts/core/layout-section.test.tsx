...
describe('LayoutSection', () => {
    it('renders children', () => {
        const { getByText } = renderWithProviders(
            <LayoutSection>Page content</LayoutSection>
        );
    ...
    it('has the root layout id', () => {
        const { container } = renderWithProviders(
            <LayoutSection>Content</LayoutSection>
        );
    ...
    it('wraps content in sidebar container when sidebar is provided', () => {
        const { container } = renderWithProviders(
            <LayoutSection
                sidebarSection={<nav>Sidebar</nav>}
        ...
        const sidebarContainer = container.querySelector(
            '[class*="layout__sidebar__container"]'
        );
    ...
    it('merges custom className', () => {
        const { container } = renderWithProviders(
            <LayoutSection className="custom-layout">Content</LayoutSection>
        );
